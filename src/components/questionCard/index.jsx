    ...
    render() {
        ...
        return (
            ...
            <View className='at-col at-col-11' style='background-color: white;border-style: solid; border-width: 1px; border-color: white;  box-shadow: 5px 5px 10px 0px rgba(0,0,0,0.1); border-radius: 5px'>
                ...
                <View className='at-row' style='height: 50px'>
                    ...
                    <Text style={rightTopFontSize} className='at-col at-col__offset-7'>{rightTop}</Text>
                    
                </View>             
                <View className='at-row at-row__justify--center'>
                    <Text className='at-col at-col-10 at-col--wrap'>{value}</Text>
                </View>
            </View>            
            </View>
            </View>
